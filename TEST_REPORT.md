...
**Date:** 2026-05-21
**Iteration:** dev iteration 1 (fresh conversion on feature branch)
...
- Source: `hello.py` (4 lines)
- Output: `Hello.java` (4 lines)
- Mapping: `print("Hello, World!")` -> `System.out.println("Hello, World!")`
- Mapping: `if __name__ == "__main__"` -> `public static void main(String[] args)`
- Java version: 22.0.2
