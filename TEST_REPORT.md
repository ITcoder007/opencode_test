...
**Date:** 2026-05-19
**Iteration:** 1 (dev iteration 1 - feature_python_to_java_20260519172704 branch)
...
- **Mapping:** `print()` -> `System.out.println()`, `def main()` -> `public static void main(String[] args)`, `if __name__ == "__main__"` -> main entry point
